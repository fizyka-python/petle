...
class TestHasło(unittest.TestCase):
    ...
    def test_correct(self, stdout):
        runfile('haslo')
        self.assertEqual(stdout.getvalue(), "Hasło jest bezpieczne.\n")

    @patchio("PPP4")
    def test_lowercase(self, stdout):
        runfile('haslo')
        self.assertEqual(stdout.getvalue(), "Hasło jest niebezpieczne!\n")
...
class Trójkąty:
    ...
    def run_test(self, variant, stdout):
        ...
        if result[0][0] == ' ':
            self.assertEqual(result, self.trojkat2(7))
            del Trójkąty.trojkat2
        else:
            self.assertEqual(result, self.trojkat1(7))
            del Trójkąty.trojkat1


class TestTrójkąt1(Trójkąty, unittest.TestCase):
    @patchio("7")
    def test_Triangle1(self, stdout):
        self.run_test(1, stdout)


class TestTrójkąt2(Trójkąty, unittest.TestCase):
    @patchio("7")
    ...
    def testPi(self, stdout):
        ...
        for i, c in enumerate(correct):
            ...
            self.assertAlmostEqual(
                r, c, 6, f"{r} != {c} (przybliżenie nr {i+1})")
